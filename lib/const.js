...
const PUBLIC_DIR = exports.PUBLIC_DIR = process.env.PUBLIC_DIR || path.resolve(__dirname, '..', 'public')
exports.UPLOAD_DIR = process.env.UPLOAD_DIR || path.resolve(PUBLIC_DIR, 'uploads')
